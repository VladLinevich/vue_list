    ...
    $.mask = {
        ...
        mask: function mask(_mask, settings) {
            ...
            return settings = $.extend({
                ...
                "?" == c ? (len--, partialPosition = i) : refs ? (tests.push(new RegExp(refs)), null === firstNonMaskPos && (firstNonMaskPos = tests.length - 1), partialPosition > i && (lastRequiredNonMaskPos = tests.length - 1)) : tests.push(null);
                ...
                function checkVal(allow) {
                    ...
                    }return allow ? writeBuffer() : partialPosition > lastMatch + 1 ? settings.autoclear || buffer.join("") === defaultBuffer ? input.val() : writeBuffer() : (writeBuffer(), input.val(input.val().substring(0, lastMatch + 1))), partialPosition ? i : firstNonMaskPos;
                }
                var input = $(this),
...
(0, _jquery2.default)('.input-code').mask('00', {
    completed: function completed() {

        var nexElem = firstNoValueElement('.input-code');
        nexElem ? nexElem.focus() : false;
    }
});

function firstNoValueElement(className) {

    var noValueItem = (0, _jquery2.default)(className).map(function (n, e) {
        var elem = (0, _jquery2.default)(e);
        if (!elem.val()) {
            return elem;
        }
    });

    return noValueItem[0];
}

function pasteCode() {

    var wrapper = (0, _jquery2.default)('.inputs-container');
    var input = wrapper.find('input');
    var symbolsInInput = 2;

    _jquery2.default.each(input, function (number, elem) {
    ...
    function paste(code) {
        ...
        if (isNaN(Number(code))) {
            ...
            for (var i = 0; i < code.length; i += symbolsInInput) {
                newArr.push(code.slice(i, i + symbolsInInput));
            }

            newArr.map(function (el, i) {
                (0, _jquery2.default)(input[i]).val(el);
            });
        }
    }
}
...
function blockButton() {
    ...
    var wrap = (0, _jquery2.default)('.fake-popup');
    var inputs = void 0;

    if (wrap.hasClass('tmp-psw')) {
        inputs = wrap.find('.inputs-container input');
    } else {
        inputs = wrap.find('input');
    }

    var btn = (0, _jquery2.default)(wrap.find('button'));
    var good = void 0;

    _jquery2.default.each(inputs, function (i, el) {
...
var listenAutocomplite = function listenAutocomplite(fn) {

    var times = {
        interval: 300,
        timesCheck: 30,
        stop: function stop() {
            return undefined.interval + undefined.timesCheck;
        }
    };
...
(0, _jquery2.default)(document).ready(function () {
    ...
    var fields = (0, _jquery2.default)('#sing-in_by-email input, #sing-in_by-phone input, #pass-recovery-1 input, #pass-recovery-2 input');
    ...
    setTimeout(function () {
        listenAutocomplite(blockButton());
    }, 1000);
});
